...
### Example of a slurm batch script that runs a software program via a singularity

Here is a slightly more complicated sbatch script that uses the fastQC software via a singularity. 
